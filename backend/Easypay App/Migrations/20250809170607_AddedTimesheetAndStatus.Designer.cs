...
namespace Easypay_App.Migrations
{
    ...
    [Migration("20250809170607_AddedTimesheetAndStatus")]
    partial class AddedTimesheetAndStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Easypay_App.Models.Timesheet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Easypay_App.Models.TimesheetStatusMaster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TimesheetStatusMasters");
            ...
            modelBuilder.Entity("Easypay_App.Models.Timesheet", b =>
                {
                    ...
                    b.HasOne("Easypay_App.Models.TimesheetStatusMaster", "Status")
                        .WithMany("Timesheets")
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
